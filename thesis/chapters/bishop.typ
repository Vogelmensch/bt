...
#figure(
  caption: [Order of bit-processing. The first and second rows show the fingerprint in hexadecimal- and binary-representation respectively; the third row shows the processing order of the bit-pairs.],
  table(
    columns: 12,
    rows: 3,
    stroke: none,
